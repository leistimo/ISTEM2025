...
const char* tz = "MST7MDT,M3.2.0,M11.1.0"; // Idaho Mountain Time
const char *time_zone = "MST7MDT,M3.2.0,M11.1.0"; // CET-1CEST,M3.5.0,M10.5.0/3";  // TimeZone rule for Europe/Rome including daylight adjustment rules (optional)
